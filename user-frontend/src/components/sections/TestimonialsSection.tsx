export function TestimonialsSection() {
  return (
    <section id="testimonials" style={{position: 'relative', backgroundColor: '#0c0c14', padding: '96px 24px', overflow: 'hidden'}}>
      ...
      <div className="container" style={{position: 'relative', zIndex: 10}}>
        ...
        <div className="testimonials-grid" style={{display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1px', backgroundColor: 'rgba(255,255,255,.06)', border: '1px solid rgba(255,255,255,.06)'}}>
